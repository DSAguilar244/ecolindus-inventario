...
<head>
    <meta charset="utf-8">
    <title>Ventas por Producto - ECOLINDUS</title>
    <style>
...
<body>
    <div class="header">
        <div class="header-title">ECOLINDUS - Reporte de Ventas por Producto</div>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr class="total-row">
                ...
                <td class="right">{{ $results->sum('quantity_sold') }}</td>
